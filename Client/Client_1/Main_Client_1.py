...
while not dh_c_status:
    ...
    print("pubkey length : ", len(str(DH_Algorithm_Client.public_key)))
    ...
    print("part 1 length : ", len(pub_key_part1))
    ...
    print("part 2 length : ", len(pub_key_part2))
    Server1_conn.sending(pub_key_part1, 0)
    Server2_conn.sending(pub_key_part2, 0)
    pub_keyC2_part1 = Server1_conn.receiving(0)
    print("keyrecv part 1 : ", pub_keyC2_part1[:15])
    print("keyrecv part 1 length : ", len(pub_keyC2_part1))
    pub_keyC2_part2 = Server2_conn.receiving(0)
    print("keyrecv part 2 : ", pub_keyC2_part2[:15])
    print("keyrecv part length 2 : ", len(pub_keyC2_part2))
    DH_Algorithm_Client.private_key_generator((pub_keyC2_part1 + pub_keyC2_part2))
    print("Private key : ", DH_Algorithm_Client.private_key[:15])
    print("Private key length : ", len(DH_Algorithm_Client.private_key))
    dh_c_status = True
